 ...
 */
@TestFor(Isa95PersonnelSpecificationProperty)
class Isa95PersonnelSpecificationPropertySpec extends Specification {
    ...
    void "test set name"() {
    	...
    	def prop = new Isa95PersonnelSpecificationProperty(name:"my-test-name")
    ...
    void "test set description"() {
    	...
    	def prop = new Isa95PersonnelSpecificationProperty(description:"my-test-description")
    	then: 'the property must be set'
    ...
    void "test set value and uom"() {
    	...
    	def prop = new Isa95PersonnelSpecificationProperty(value:"my-test-value", valueUOM:"ohm")
    ...
    void "test set quantity double value and uom"() {
    	...
    	def prop = new Isa95PersonnelSpecificationProperty(quantity:12.25, quantityUOM:"kilograms")
    	then: 'the properties must be set'
    	prop.quantity == 12.25
    ...
    void "init the whole object"() {
    	...
    	def prop = new Isa95PersonnelSpecificationProperty(
    		name:"my-test-name",
