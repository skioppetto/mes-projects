 ...
 */
@TestFor(Isa95EquipmentSpecificationProperty)
class Isa95EquipmentSpecificationPropertySpec extends Specification {
    ...
    void "test set name"() {
    	...
    	def prop = new Isa95EquipmentSpecificationProperty(name:"my-test-name")
    ...
    void "test set description"() {
    	...
    	def prop = new Isa95EquipmentSpecificationProperty(description:"my-test-description")
    	then: 'the property must be set'
    ...
    void "test set value and uom"() {
    	...
    	def prop = new Isa95EquipmentSpecificationProperty(value:"my-test-value", valueUOM:"ohm")
    ...
    void "test set quantity double value and uom"() {
    	...
    	def prop = new Isa95EquipmentSpecificationProperty(quantity:12.25, quantityUOM:"kilograms")
    	then: 'the properties must be set'
    	prop.quantity == 12.25
    ...
    void "init the whole object"() {
    	...
    	def prop = new Isa95EquipmentSpecificationProperty(
    		name:"my-test-name",
